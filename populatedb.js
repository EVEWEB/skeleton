...
var makey=(function (callback){
    var quickAuthor=new Author({first_name:'dougle', family_name:'TREE', d_birth:'1234-56-78', d_death:false, callback});
    ...
    // }
    quickAuthor.save();
    authors.push(quickAuthor);
    console.log('new, quick author: '+quickAuthor);
})();
